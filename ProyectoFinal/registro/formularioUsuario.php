...
<head>
    <?php
    include_once '../login/scripts.php';
    ?>
    <!-- Required meta tags-->
    <meta charset="UTF-8">
    ...
    <!-- Title Page-->
    <title>InfoGaming Registro</title>
    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Registro Usuarios</h2>
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-icon">
                                        <input class="input--style-4 js-datepicker" type="date" name="fecha_nacimiento">
